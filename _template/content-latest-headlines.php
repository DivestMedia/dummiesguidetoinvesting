...
<section id="most-viewed">
    <div class="container">
        ...
        <a href="http://www.marketmasterclass.com/category/articles/starting-out/" class="btn btn-viewmore btn-lg uppercase btn-yellow noradius size-12 bold pull-right">VIEW MORE</a>
        <h4 class="uppercase size-25 bold">Starting Out</h4>
        <hr />
