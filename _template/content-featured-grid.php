...
<section class="featured-grid" >
    <div class="container">
        <h4 class="uppercase size-25 bold">Featured Articles By</h4>
        <hr>
        <a href="http://www.marketmasterclass.com/" class="text-white underline" style="    margin: 0 auto; display: block; width: 160px; margin-bottom: 50px;">
