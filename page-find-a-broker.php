...
<section id="features" class="section-findabroker">
	...
	<div class="container">
		...
		<div class="callout alert alert-transparent noborder margin-top-50">

			<div class="text-center">

				<h3><strong>To continue reading,</strong></h3>
				<p class="font-lato size-20">Visit original article on</p>

				<a href="http://www.marketmasterclass.com/find-a-broker/" class="text-white underline" style="    margin: 0 auto; display: block; width: 160px; margin-bottom: 50px;">
					<img src="http://www.marketmasterclass.com/wp-content/themes/mmcv2/assets/img/mmc-logo-dark.png" class="width-150">
				</a>
